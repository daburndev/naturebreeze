...
?>
<html>
<head><title>Naturebreeze | Login</title>
...
<header id="header"><!--header-->
	...
	<section id="form"><!--form-->
		<div class="container">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1" style="width:100%; margin: 0 auto;">
					<div class="login-form" style="width:35%; margin: 0 auto;"><!--login form-->
						...
						<form action="#" method="POST">
							<input type="text" placeholder="Email Address" name="aname" />
							<input type="password" placeholder="Password" name="apw" />
