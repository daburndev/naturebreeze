...
<header id="header"><!--header-->
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="newstaff.php"><i class="fa fa-user"></i>New Staff</a></li>
 ...
 <h3 align="center">Welcome <?php if(!empty($_SESSION['aname']))echo "<font color=\"red\">".$_SESSION['aname']."</font>";?> From  Admin Panel</h3>       
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
